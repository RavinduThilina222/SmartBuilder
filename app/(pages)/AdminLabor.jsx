...
export default function AdminLabor() {
    ...
    <View style={styles.main}>
      ...
      <Animated.View style={[styles.navigationPane, { transform: [{ translateX: slideAnim }] }]}>
        ...
        <View style={styles.buttonContainer}>
          <CustomButton title="Add Labour" />
          <CustomButton title="View Labour" />
          <CustomButton title="Update Labour" />
          <CustomButton title="Delete Labour" />
        </View>
